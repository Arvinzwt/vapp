        ...
        <el-dialog title="选择知识点" :visible.sync="knowdgeVisible">
          <el-form :model="knowdgeForm" :rules="knowdgeRules" ref="knowdgeForm" size="mini">
            <el-form-item label="类型" prop="type">
              <el-radio-group v-model="knowdgeForm.type">
                <el-radio label="同步"></el-radio>
                <el-radio label="专题"></el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="学科" prop="subject">
              <el-radio-group v-model="knowdgeForm.subject" disabled>
                <el-radio label="线上品牌商赞助"></el-radio>
                <el-radio label="线下场地免费"></el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="版本" prop="version" v-if="!otherShow">
              <el-radio-group v-model="knowdgeForm.version">
                <el-radio label="线上品牌商赞助"></el-radio>
                <el-radio label="线下场地免费"></el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="年级" prop="level" v-if="!otherShow">
              <el-radio-group v-model="knowdgeForm.level" :disabled="!knowdgeForm.type">
                <el-radio label="线上品牌商赞助"></el-radio>
                <el-radio label="线下场地免费"></el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="学期" prop="semester" v-if="!otherShow">
              <el-radio-group v-model="knowdgeForm.semester" :disabled="!knowdgeForm.level">
                <el-radio label="线上品牌商赞助"></el-radio>
                <el-radio label="线下场地免费"></el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="学段" prop="section" v-if="otherShow">
              <el-radio-group v-model="knowdgeForm.section">
                <el-radio label="线上品牌商赞助"></el-radio>
                <el-radio label="线下场地免费"></el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="地区" prop="area" v-if="otherShow">
              <el-radio-group v-model="knowdgeForm.area" :disabled="!knowdgeForm.section">
                <el-radio label="线上品牌商赞助"></el-radio>
                <el-radio label="线下场地免费"></el-radio>
              </el-radio-group>
            </el-form-item>
