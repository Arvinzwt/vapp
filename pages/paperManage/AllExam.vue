    ...
    <el-main>
        <div class="unaudit-exam">
          <div class="header">
                ...
                <el-table-column label="操作" align="right">
                  <template slot-scope="scope">
                    ...
                    <el-button
                      size="mini"
                      type="text"
                      @click="viewLogs(scope.$index, scope.row)"
                    >
                      查看日志
                    </el-button>
                    <el-button
            ...
            <el-dialog title="修改日志列表" :visible.sync="logVisible">
              <el-table :data="logData">
                <el-table-column property="date" label="操作时间" width="150"></el-table-column>
                <el-table-column property="name" label="操作动作" width="200"></el-table-column>
                <el-table-column property="address" label="操作人"></el-table-column>
              </el-table>
              <span slot="footer" class="dialog-footer">
                <el-button @click="logVisible = false" size="mini">关 闭</el-button>
              </span>
            </el-dialog>
            <el-dialog
            title="试卷分析"
