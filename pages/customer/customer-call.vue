                ...
                <el-row :gutter="15" v-show="paramMap.show">
                    ...
                    <el-col :span="6">
                        <el-form-item label="呼入类型">
                            <el-select v-model="paramMap.incomingType" placeholder="请选择" clearable>
                                <el-option
                    ...
                    <el-col :span="6">
                        <el-form-item label="坐席">
                            <el-input :maxlength='50' v-model="paramMap.seat" placeholder="请输入内容" clearable/>
                        </el-form-item>
                    </el-col>
                    <!--渠道小类-->
                    <el-col :span="6">
                        <el-form-item label="渠道小类">
                            <el-input :maxlength='50' v-model="paramMap.smallChannel" placeholder="请输入内容" clearable/>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="15">
