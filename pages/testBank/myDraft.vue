                ...
                <div class="draft-main-item" v-for="item in list" :key="item.questionId">
                    ...
                    <div class="draft-main-foot">
                        <el-link type="primary" class="draft-main-foot-item font-basic" @click="showTestResolve(item)">
                            <span>解析</span>
                            <span style="margin-left: 5px" v-show="!item.showResolve" class="el-icon-arrow-down"></span>
                ...
                <div v-if="dialog.type===2">
                    ...
                    <el-form-item label="所属知识点">
                        <div class="box-item mar-b-15">
                            <div class="box-left">
                                <KnowledgeTree v-model="dialog.form.knowledgeIds1">同步</KnowledgeTree>
                            </div>
                            <div class="box-right">
                                <div class="jr-tag">
                        ...
                        <div class="box-item mar-b-15">
                            <div class="box-left">
                                <KnowledgeTree v-model="dialog.form.knowledgeIds2" :type="2">专题</KnowledgeTree>
                            </div>
                            <div class="box-right">
                                <div class="jr-tag">
                                    <div class="jr-tag-item" v-for="item in dialog.form.knowledgeIds2"
                                         :key="item.knowledgeId">
                                        <span>{{item.name}}</span>
                    ...
                    <el-form-item label="能力">
                        <div class="jr-tag">
                            <div class="jr-tag-item">问题解决</div>
                            <div class="jr-tag-item">空间观念</div>
                            <div class="jr-tag-item">基本运算</div>
                        </div>
                    </el-form-item>
                </div>
