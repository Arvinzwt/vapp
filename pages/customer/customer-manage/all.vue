    ...
    <div class="jr-customer-customer-manage-public">
        ...
        <el-form class="jr-form" size="mini" :model="paramMap" label-width="90px"
            ...
            <el-row :gutter="15">
                ...
                <el-col :span="6">
                    <el-form-item label="跟进状态">
                        <el-select v-model="paramMap.last_trace_status" multiple collapse-tags placeholder="请选择" clearable>
                            <el-option
                ...
                <el-col :span="6">
                    <el-form-item label="海域">
                        <el-select v-model="paramMap.area_code" multiple collapse-tags placeholder="请选择" clearable>
                            <el-option
                                    v-for="item in dic.sea"
                                    :key="item.value"
                                    :label="item.name"
                                    :value="item.value">
                            </el-option>
                ...
                <el-row :gutter="15">
                    ...
                    <el-col :span="6">
                        <el-form-item label="客户状态">
                            <el-select v-model="paramMap.leads_status" multiple collapse-tags placeholder="请选择" clearable>
                                <el-option
            ...
            <el-row :gutter="15">
                <!--创建时间-->
                <el-col :span="6">
                    <el-form-item label="创建时间" v-show="paramMap.show">
                        <el-date-picker
        ...
        <el-table @sort-change="tableSortChange" class="jr-table" ref="filterTable" :data="tableData" size="mini">
            ...
            <el-table-column label="海域" prop="area_code"/>
